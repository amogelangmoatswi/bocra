...
export const NoiseBackground = ({
  ...
  containerClassName,
  gradientColors = [
    "rgb(0, 85, 164)",   // bocra-blue
    "rgb(46, 139, 87)",  // bocra-green
    "rgb(245, 166, 35)", // bocra-yellow
  ],
  noiseIntensity = 0.5,
  speed = 0.1,
  backdropBlur = false,
  ...
  return (
    ...
    >
      ...
      {/* Top gradient strip */}
      <motion.div
        className="absolute inset-x-0 top-0 h-1 rounded-t-2xl opacity-40 blur-sm"
        style={{
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div 
          className="h-full w-full opacity-[var(--noise-opacity)] pointer-events-none"
          style={{ 
